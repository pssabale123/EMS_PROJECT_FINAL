...
import AddPaper from "./AddUpdatePaper";
...
export const PaperSetterDashboard = () => {
  ...
  const handleAdd = () => {
    ...
    if (location.pathname == "/paperSetter/papers") {
      navigate("papers/addPaper");
    } else if (window.location.pathname == "/paperSetter/paperQuestions") {
      navigate("paperQuestions/addPaperQuestion");
    } else navigate("studentPapers/addStudentPaper");
  };

  return (
    <div className="h-screen w-[95%] mx-auto flex rounded-lg ">
      <div className="h-full  bg-[#172337] " style={{ flex: "1" }}>
        <div className="my-2">
          <img className="w-full" src={emsIcon} />
        </div>
        <div>
          <NavLink className="bg-[#FFD630] flex mx-2 p-1" to="dashboard">
            <MdDashboard size={25} />
            <span className="ml-2">Dashboard</span>
          </NavLink>
        </div>
      </div>
      <div style={{ flex: "5" }} className="h-[200]">
        ...
        <div className="px-4 h-[calc(100vh-60px)] overflow-x-auto paperWindow">
          ...
          {/* dashboard content */}
          {/* className="px-4 h-[calc(100vh-60px)] overflow-x-auto paperWindow"> */}
          <div className="flex item-center">
            <NavLink
              className={`active mx-2 py-1 px-10 text-gray-500 outline-none border-b-[2px] border-slate-300 text-base  font-semibold focus:text-yellow-400 focus:border-b-[2px] focus:border-yellow-400  `}
              to="papers"
            >
              Paper
            </NavLink>
